...
<div class="container">
  ...
  <div id="formContent">
	...
	<h2>S'inscrire</h2>
		<input type="text" id="nom" class="fadeIn second" name="nom" placeholder="Saisir votre nom">
		<input type="text" id="prenom" class="fadeIn second" name="prenom" placeholder="Saisir votre prenom">
      <input type="text" id="login" class="fadeIn second" name="pseudo" placeholder="Saisir le pseudo">
